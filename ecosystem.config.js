...
module.exports = {
  ...
  deploy: {
    development: {
      ...
      'post-setup': `echo MONGO_URI_FULL_BASE64 = ${process.env.MONGO_URI_FULL_BASE64.replace(/\n/g, '\\n')} > .env` +
      ` && echo EXPRESS_SECRET_BASE64 = ${process.env.EXPRESS_SECRET_BASE64.replace(/\n/g, '\\n')} >> .env` +
      ...
      ` && echo SMTP_PWD_BASE64 = ${process.env.SMTP_PWD_BASE64.replace(/\n/g, '\\n')} >> .env` +
